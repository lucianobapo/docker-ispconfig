...
RUN ls -la /etc/nginx && ls -la /etc/nginx/sites-available && ls -la /etc/nginx/sites-enable && ln -s /etc/nginx/sites-available/default-php /etc/nginx/sites-enable/default-php
