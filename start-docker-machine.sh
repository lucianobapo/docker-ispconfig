...
git cmt
docker-machine ssh ispconfig-machine "git clone https://github.com/lucianobapo/docker-ispconfig.git -q && cd ~/docker-ispconfig && git pull && docker-compose down && docker-compose up -d"
