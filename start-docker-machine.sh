...
git cmt
docker-machine ssh ispconfig-machine "git clone https://github.com/lucianobapo/docker-ispconfig.git && cd ~/docker-ispconfig && docker-compose down && docker-compose up -d"
