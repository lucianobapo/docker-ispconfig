...
git cmt
docker-machine ssh ispconfig-machine "git clone -q https://github.com/lucianobapo/docker-ispconfig.git && cd ~/docker-ispconfig && git pull && docker-compose down && docker-compose up -d"
